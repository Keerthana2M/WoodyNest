...
const SellerLogin = () => {
  ...
  return  !isSeller && (
    <form onSubmit={onSubmitHandler} className='min-h-screen flex items-center text-sm text-gray-600'>
        <div className='flex flex-col gap-5 m-auto items-startp-8 py-12 min-w-80 sm:min-w-88 rounded-lg shadow-xl border-gray-200'>
            ...
            <button className='bg-primary text-white w-full py-2 rounded-2xl cursor-pointer'>Login</button>
        </div>
    </form>
  )
}
