...
const AddProduct = () => {
  ...
  return (
        ...
        <div onSubmit={onSubmitHandler} className="no-scollbar flex-1 h-[95vh] overflow-y-scroll flexflex-col justify-between">
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-2">
                        {Array(4).fill('').map((_, index) => (
                            <label key={index} htmlFor={`image${index}`}>
                                ...
                                <img className="max-w-24 cursor-pointer" src={files[index]? URL.createObjectURL(files[index]):assets.u} alt="uploadArea" width={100} height={100} />
